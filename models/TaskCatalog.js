...
const taskCatalogSchema = new mongoose.Schema({
  ...
  nameLower: { type: String, required: true }   // pre porovnávanie bez ohľadu na veľkosť písmen (bez duplicít)
}, { timestamps: true });

taskCatalogSchema.index({ user: 1, type: 1, nameLower: 1 }, { unique: true });
